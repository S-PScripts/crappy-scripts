...
print("antijump - if your jumppower is changed it'll reset it to 100")
...
print("antispeed - if your speed is changed it'll reset your speed to 16")
...
print("antigearban - stops people gearbanning you with the portable justice")

print("-----------TELEPORTS---------")
print("house - teleport to the house")
print("spawn - teleport to spawn")
print("fastpads - just tps to each of the pads lol")
...
print("------------ADMIN------------")
print("admin plr - give plr admin to st- borrow from you")
print("unadmin plr - no more free admin for the user >:)")
