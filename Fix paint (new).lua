game.Players.LocalPlayer.Chatted:Connect(function(msg)
    if command == ".fixcolour" then
          loadstring(game:HttpGet("https://raw.githubusercontent.com/S-PScripts/kah-scripts/main/Fix%20Paint.lua"))
    end
    if string.sub(msg:lower(), 1, 10) == ".colourmap" then
       ColourHere = string.sub(msg:lower(), 12)
       ihatedmakingthis()
    end
end)

local function ihatedmakingthis()
colorAPI = {}
